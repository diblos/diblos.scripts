...
Select Case WScript.Arguments(0)
 ...
 Case else
  Wscript.Echo "Usage:"
  Wscript.Echo "msmq.vbs /send"
  Wscript.Echo "msmq.vbs /peek"
  Wscript.Echo "msmq.vbs /receive"
End Select
Function Help()
  Wscript.Echo "Usage:"
  Wscript.Echo "msmq.vbs /send /f:DIRECT=OS:machine\private$\test"
  Wscript.Echo "msmq.vbs /peek /f:DIRECT=OS:machine\private$\test"
  Wscript.Echo "msmq.vbs /receive /f:DIRECT=OS:machine\private$\test"
End Function