...
'strDirectory = "C:\Documents and Settings\Administrator.ITAC-P023\Desktop\POLRI\AIDS"
strDirectory = left(WScript.ScriptFullName,(Len(WScript.ScriptFullName))-(len(WScript.ScriptName)))
strFile = "\Summer.txt"
