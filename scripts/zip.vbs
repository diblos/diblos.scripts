...
folder2zip = "D:\fromSDE_VmmHfm"
destFile = "D:\Archives " & getFormattedDate & ".zip"

arrResult = ZipFolder( folder2zip, destFile)
'arrResult = ZipFolder( currentDirectory & "logs", currentDirectory & "old\log-" & getFormattedDate & ".zip" )
